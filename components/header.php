...
<head>
    ...
    <title>Revista de Negócios</title>
                ...
                <div class="container">
                    <div class="textura1">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.php"><img class="logo" src="assets/images/logo-revista-negocios.png" alt="Logo - Revista de Negócios" /></a>
                        </div><!-- .navbar-header -->

                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li><a href="">A Revista</a></li>
                                <li><a href="">Notícias</a></li>
                                <li><a href="">TV Negócios</a></li>
